...
# Llumlet, AsyncPutQueueActor, APIServerActor and Worker share the same 1 gpu in the first bundle of PlacementGroup.
...
USAGERATIO_BUSY_THRESHOLD: float = 1.0
REMAININGSTEPS_BUSY_THRESHOLD: float = 5
