...
from llumnix.backends.bladellm.worker import launch_worker_ray
from llumnix.constants import NCCL_PORT
...
class AsyncBackQueueWrapper(APIWrapper):
    def __init__(self,
                 ...
                 instance_id: str,
                 request_output_queue_type: QueueType) -> None:
...
class AsyncLLMEngineLlumnixMixin:
    ...
    def __init__(self,
        ...
        self._worker_processes = launch_worker_ray(placement_group, self._args, instance_id, migration_config)
