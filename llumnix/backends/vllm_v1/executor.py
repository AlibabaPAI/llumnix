...
class LlumnixRayDistributedExecutor(RayDistributedExecutor):
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup",
        ...
        for rank in range(world_size):
            ...
            # TODO(shejiarui): specify worker's name
            worker_name = f"worker_{dp_rank}_{rank}"
            if current_platform.ray_device_key == "GPU":
                ...
                logger.debug(f"[sjr] Creating worker_{dp_rank}_{rank} with bundle_idx={dp_rank}, asking for {num_gpus} GPUs.")
            else:
