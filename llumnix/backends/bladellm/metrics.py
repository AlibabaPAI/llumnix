...
from llumnix.metrics.variable import PassiveStatus
...
class BladeLLMMetrics(LlumnixMetrics):
    def __init__(self):
        super().__init__()
        self.num_cached_request_ids = PassiveStatus("num_cached_request_ids")
        self.all_wait_update_request_ids = PassiveStatus("all_wait_update_request_ids")
    ...
    def engine_init_metrics(self, engine):
        ...
        self.all_request_ids.observe(engine.get_all_request_ids)
        self.all_wait_update_request_ids.observe(engine.get_all_wait_update_request_ids)
