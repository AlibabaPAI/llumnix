...
class LLMEngineManager:
    ...
    def generate(
        ...
        if self.generate_mode == 'original':
            self.generate_original(session_id, prompt, sampling_params, request_id, prompt_token_ids, arrival_time, priority_type=priority_type)
    ...
    def generate_original(
            ...
            arrival_time: float = None,
            priority_type: int = 0,):
        instance_id = self.request_scheduler.dispatch(session_id, priority_type)
        ...
        self.instances[instance_id].add_request(request_id, prompt, sampling_params, prompt_token_ids, arrival_time=arrival_time, priority_type=priority_type)
