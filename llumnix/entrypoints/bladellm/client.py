...
from llumnix.utils import asyncio_wait_for_with_timeout, is_traced_request, enable_request_trace
...
class LlumnixClientBladeLLM(LlumnixClient, MultiProcessingLLMClient):
    ...
    async def _generate(self, request_id: int, request: Union[ServerRequest, LlumnixServerRequest]) -> LLMResponse:
            ...
            for request_response in request_responses:
                ...
                if request_timestamp:
                    ...
                    if entrypoint_req_id is not None:
                        ...
                        request_output.set_request_timestamp(request_timestamp)
