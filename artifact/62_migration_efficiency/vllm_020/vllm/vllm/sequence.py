...
class SequenceEvent(enum.Enum):
    ...
    MIGRATE_OUT_STAGE_0 = enum.auto()
    MIGRATE_OUT_STAGE_1 = enum.auto()
    ...
    def get_event(event: "SequenceEvent") -> str:
        if event == SequenceEvent.PREFILL:
            ...
            return "migrate_in"
        elif event == SequenceEvent.MIGRATE_OUT_STAGE_0:
            return "migrate_out_stage_0"
        elif event == SequenceEvent.MIGRATE_OUT_STAGE_1:
            return "migrate_out_stage_1"
        return None
