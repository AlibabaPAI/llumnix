...
class LLMEngineManager:
    ...
    async def generate(
        ...
        if self.generate_mode == 'original':
            ...
            outputs_generator = self.generate_callback(session_id, prompt, sampling_params, request_id, prompt_token_ids, arrival_time)
    ...
    def _init_workers_ray(self, placement_group: "PlacementGroup") -> None:
        ...
        for idx,bundle in enumerate(placement_group.bundle_specs):
