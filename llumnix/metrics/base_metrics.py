...
class LlumnixMetrics(ABC):
    def __init__(self):
        ...
        # used for migration
        self.num_blocks_last_running_request = PassiveStatus("num_blocks_last_running_request")
        self.num_blocks_first_waiting_request = PassiveStatus("num_blocks_first_waiting_request")

        # stastics
        self.num_watermark_blocks = Status("num_watermark_blocks")
        self.num_killed_requests = PassiveStatus("num_killed_requests")
        self.all_request_ids = PassiveStatus("all_request_ids")
