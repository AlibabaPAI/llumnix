...
if __name__ == "__main__":
    ...
    parser.add_argument("opts", default=None, nargs=argparse.REMAINDER, help="modify config options using cli")
    args = parser.parse_args()

    cfg: LlumnixConfig = get_llumnix_config(args.config_file, args.opts)
    ...
    if is_gpu_available():
        ...
        print(f"Start Api Server on '{cfg.SERVER.HOST}:{cfg.SERVER.PORT}'")
        uvicorn.run(app,
