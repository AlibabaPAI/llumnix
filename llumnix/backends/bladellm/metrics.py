...
class BladeLLMMetrics(LlumnixMetrics):
    def __init__(self):
        ...
        self.num_msg_producer_cached_request = PassiveStatus("num_msg_producer_cached_request")
    ...
    def engine_init_metrics(self, engine):
        ...
        self.num_msg_producer_cached_request.observe(engine.get_num_msg_producer_cached_request)
