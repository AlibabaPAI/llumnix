...
class MigrationWorker(Worker):
    def __init__(self, *args, **kwargs) -> None:
        ...
        migrate_size = int(os.environ.get("MIGRATE_CACHE_SIZE", 1))
        ...
        if backend == "nccl" and (not pp_or_tp_enabled):
            ...
            num_head = model_config.get_num_kv_heads(parallel_config)
            hidden_size = model_config.get_hidden_size()
            total_size = migrate_size * num_layer * block_size * num_head * hidden_size
