...
def init_output_queue_server(zmq_ip: str, zmq_port: int, queue_type: QueueType) -> QueueServerBase:
...
def init_output_queue_client(queue_type: QueueType) -> QueueClientBase:
