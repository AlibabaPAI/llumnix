...
from llumnix.utils import as_local
...
def test_engine_step_exception(ray_env):
    engine_args = EngineArgs(model=as_local("facebook/opt-125m"), download_dir="/mnt/model", max_model_len=8, worker_use_ray=True, enforce_eager=True)
