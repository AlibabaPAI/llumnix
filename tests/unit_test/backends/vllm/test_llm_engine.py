...
def test_llm_engine_from_engine_args():
    ...
    llm_engine = MockEngine.from_engine_args(engine_args, output_queue_type='rayqueue',
...
def test_llm_engine_add_requset():
    engine_args = EngineArgs(model="facebook/opt-125m", worker_use_ray=True)
    llm_engine = LLMEngineLlumnix.from_engine_args(engine_args, output_queue_type='rayqueue', instance_id="0",
